...
2. Install the XFCE4 desktop with additional applications: `pkg install xfce4 xfce4-goodies xfce4-terminal`
   ...
   * Make sure you have enabled the X11 repository. If you didn't, read [this](https://github.com/GlitchBlake/Termux-Tutorials/edit/main/Tutorials/Getting%20Started/termux_basics.md).
