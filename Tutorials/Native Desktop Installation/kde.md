...
```
3. Install the KDE Plasma desktop with additional applications
```
pkg install plasma kde-applications kwin-x11 konsole
```
...
```
5. Start the X11 server along with the KDE Plasma desktop
```
